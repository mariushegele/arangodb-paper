...
\lstdefinelanguage{ArangoQL}{
  sensitive=false,
  morekeywords={FOR,IN,FILTER,OUTBOUND,RETURN,SORT,LIMIT,SEARCH,ASC,DESC,COLLECT,INTO,LET,AND},
...
\abstract{ArangoDB is NoSQL database with a multi-model paradigm. In this paper we will demonstrate its characteristics and features. We will compare it to traditional SQL mechanisms and compare it with other NoSQL databases.}
